...
<div className="board-widget-content">
    <a className="member js-member ui-draggable ui-draggable-handle ui-draggable-disabled" title=" (xet7)" href="#" aria-label=" (xet7)">
...
<a className="member js-member ui-draggable ui-draggable-handle ui-draggable-disabled" title=" (wjdqls1342)" href="#" aria-label=" (wjdqls1342)">
  <svg className="avatar avatar-initials" viewBox="0 0 12 15"><text x="50%" y="13" text-anchor="middle">W</text></svg>
